...
import com.five_days.ars_titans.ArsNouveauRegistry;
...
public class ArsProviders {
    ...
    static String root = ArsTitans.MODID;
    ...
    public static class GlyphProvider extends GlyphRecipeProvider {
        ...
        public void run(CachedOutput cache) throws IOException {
            ...
            //manipulation essence, diamond block, netherite block, brick
            recipes.add(get(SquaredShapeEffect.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withItem(Items.DIAMOND_BLOCK).withItem(Items.NETHERITE_BLOCK).withItem(Items.BRICK));

            //manipulation essence, diamond block, netherite block, slime ball
            recipes.add(get(CircularShapeEffect.INSTANCE).withItem(ItemsRegistry.MANIPULATION_ESSENCE).withItem(Items.DIAMOND_BLOCK).withItem(Items.NETHERITE_BLOCK).withItem(Items.SLIME_BALL));

            //manipulation essence, diamond block, netherite block, nether star x7
